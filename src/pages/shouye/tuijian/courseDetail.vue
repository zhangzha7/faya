<template>
  <view class="wrap">
    ...
    <view class="bottom">
      ...
      <text class="title">教师简介</text>
      <view class="content">
        <text class="contentText">{{info.teacherIntro}}</text>
      </view>
      <text class="title">课程介绍</text>
      <view class="content">
        <text class="contentText">{{info.courseIntro}}</text>
      </view>
      <hr>
      <view class="comment">
        <view class="br"></view>
  ...
  methods:{
    ...
    likeChangeFunction(operateLike){
      if(operateLike===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/course/giveCourseALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/course/cancelCourseALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
    ...
    collectChangeFunction(operateCollect){
      if(operateCollect===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/course/collectCourse`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/course/cancelCourseCollect`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
