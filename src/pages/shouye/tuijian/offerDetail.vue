<template>
  <view class="wrap">
    ...
    <view class="bottom">
      ...
      <view class="content">
        <text class="contentText">{{info.unit}}</text>
      </view>
      <text class="title">薪资待遇</text>
      <view class="content">
        <text class="contentText">{{info.salary}}</text>
      </view>
  ...
  methods:{
    ...
    likeChangeFunction(operateLike){
      if(operateLike===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/offer/giveOfferALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/offer/cancelOfferALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
    ...
    collectChangeFunction(operateCollect){
      if(operateCollect===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/offer/collectOffer`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/offer/cancelOfferCollect`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
