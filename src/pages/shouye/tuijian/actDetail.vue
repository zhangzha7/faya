  ...
  methods:{
    ...
    likeChangeFunction(operateLike){
      if(operateLike===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/activity/giveActALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/activity/cancelActALike`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
    ...
    collectChangeFunction(operateCollect){
      if(operateCollect===false){
        ...
        uni.request({
          url: `${this.base.url}/api/home/activity/collectAct`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
        ...
        uni.request({
          url: `${this.base.url}/api/home/activity/cancelActCollect`,
          method:'POST',
          data:{
            uid:this.openId,
            itemId:this.info.id
